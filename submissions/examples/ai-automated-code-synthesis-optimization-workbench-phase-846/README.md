...
## What does this do?
A single-page UI showcase visualizing an AI workbench that synthesizes code, then analyzes and optimizes it in real time — animated code stream, optimization gauge, and live metric cards.
